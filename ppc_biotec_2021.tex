...
\begin{table}[H]
	...
	\resizebox{\textwidth}{!}{%
		\begin{tabular}{|l|l|l|l|l|l|}
			...
			\multicolumn{2}{|l|}{Carga horária semanal dos Núcleos Básico, Politécnico e Profissional} %(54×7)+(108×5) = 864
			                                                                               & 38         & 42        & 34        & 3078      \\ \hline
...
\begin{figure}[!htp]
	\centering
	\includegraphics[width=.6\textwidth]{DiagramaSemanal2021_01}
...
\begin{figure}[!htp]
	\centering	
	\includegraphics[width=.6\textwidth]{DiagramaSemanal2021_02}
...
\begin{figure}[!htp]
	\centering	
	\includegraphics[width=.6\textwidth]{DiagramaSemanal2021_03}
