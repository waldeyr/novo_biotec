...
\begin{table}[H]
	...
	\resizebox{\textwidth}{!}{%
		\begin{tabular}{|l|l|l|l|l|l|}
			...
			\multicolumn{2}{|l|}{Número de disciplinas por ano}                            & 15         & 17        & 14        & 46        \\ \hline
		\end{tabular}%
	}
\end{table}
...
\begin{itemize}
	...
	Enzimas;
	\VER{Vacinas, antibióticos, antifúngicos, fatores sanguíneos, hormônios, interferons, interleucinas, anticorpos monoclonais;Vai para \nameref{disc:biotecSaude}?} 
