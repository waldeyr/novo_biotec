...
\begin{table}[H]
	...
	\resizebox{\textwidth}{!}{%
		\begin{tabular}{|l|l|l|l|l|l|}
			...
			\multicolumn{2}{|l|}{Carga horária semanal dos Núcleos Básico  e Politécnico}  & 38         & 32        & 20        & 2160      \\ \hline
			%(108×3) = 324
			\multirow{7}{*}{Técnico}       
			...
			\multicolumn{2}{|l|}{Carga horária semanal dos Núcleos Básico, Politécnico e Profissional} %(54×6)+(108×5) = 864
			                                                                               & 38         & 40        & 36        & 3078      \\ \hline
			...
			\multicolumn{2}{|l|}{}                                                         & 38         & 40        & 36        & 3354      \\ \hline
			\multicolumn{2}{|l|}{Número de disciplinas por ano}                            & 14         & 17        & 14        & 45        \\ \hline
		\end{tabular}%
	}
\end{table}
...
\begin{itemize}
	...
	\begin{itemize}	
		...
		Reações químicas;
		Noções de radioatividade;
		%Equilíbrio em meio homogêneo (Ácido - Base);
...
\begin{itemize}
	...
	%: modelos para cor da pele humana e discussão das questões étnico-raciais à luz da genética moderna;
...
Introdução ao Metabolismo: visão geral do metabolismo de carboidratos (glicólise, ciclo de Krebs, cadeia respiratória e fosforilação oxidativa) e integração geral do metabolismo;
	...
	%\VER{Modificações bioquímicas dos alimentos durante o desenvolvimento, processamento e armazenamento\footnote{veio de Alimentos};}
...
\begin{itemize}
	...
	\VER{Vacinas, hormônios, interferons, interleucinas, anticorpos monoclonais;\footnote{Veio de biofármacos.}}
...
\newpage
%\subsection{Instrumentação e Controle de Bioprocessos}\label{disc:producao}
