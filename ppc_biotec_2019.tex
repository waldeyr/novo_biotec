...
\begin{itemize}
	...
	\item \textbf{Carga Horária do Curso:}~\VER{3400} horas
...
O perfil do egresso leva em conta a formação integral afim de promover o desenvolvimento do estudante na sua totalidade, considerando as dimensões físico-psíquico-cognitiva, histórica, social e profissional.
...
O Curso tem duração total de~\VER{3400} horas distribuídas em três anos.
A carga horária total está assim distruída:
\begin{itemize}
	\item \VER{3132} horas de disciplinas
	\item \VER{200} horas de estágio curricular
	\item \VER{68} horas de atividades complementares
\end{itemize}
...
\subsection{Práticas Profissionais}\label{praticasprofissionais}
\indent

As práticas profissionais enquanto uma dimensão do processo de formação do educando está presente como componente da matriz curricular com carga horária definida.
As práticas profissionais como uma dimensão do processo ensino-aprendizagem dialogam com a pesquisa e extensão como princípios e métodos pedagógicos. 
Por meio das práticas profissionais desenvolvidas em ambientes especiais de ensino, tais como laboratórios, ateliês, oficinas, ginásios e outros, as áreas acadêmicas proporcionam a integração da teoria com a prática e a articulação com os organismos sociais, incluindo a interação com as situações reais de trabalho. 
...
As atividades de caráter acadêmico, técnico, científico, artístico, cultural, esportivo, de inserção comunitária e as práticas profissionais vivenciadas pelo educando integram o currículo dos cursos técnicos correspondendo a 68 horas.
As atividades complementares devem ser cumpridas pelo aluno no período em que o mesmo estiver cursando as disciplinas da matriz curricular do curso, sendo um componente obrigatório para a conclusão do mesmo. 
As integralização deste componente deverá obedecer aos dispostos no regulamento das Atividades Complementares dos cursos técnicos, aprovado pelo Conselho Superior da Instituição.
