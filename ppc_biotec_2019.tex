...
O Curso tem duração total de~\VER{3910} horas distribuídas em três anos.
A carga horária total está assim distruída:
\begin{itemize}
	\item \VER{3078} horas de disciplinas com ementas categóricas
	\item \VER{432} horas de disciplinas com ementas flexíveis
...
\begin{table}[H]
	...
	\resizebox{\textwidth}{!}{%
		\begin{tabular}{|l|l|l|l|l|l|}
			...
			& \nameref{disc:bioeticalab}                                                   & 4          & 0         & 0         & 108       \\ \cline{2-6} 		
			& \nameref{disc:estudo}                                                        & 8          & 8         & 0         & 432       \\ \hline	
			\multicolumn{2}{|l|}{Carga horária semanal dos Núcleos Básico  e Politécnico}  & 46         & 38        & 22        & 2862      \\ \hline
			\multirow{7}{*}{Técnico}       
			...
			\multicolumn{2}{|l|}{}                                                         & 46         & 46        & 38        & 3910      \\ \hline
...
\begin{figure}[!htp]
	\includegraphics[width=\textwidth]{DiagramaSemanal01.pdf}
	\caption{Distribuição da carga horária semanal no 1º Ano.}
	\label{fig:DiagramaSemanal01}
\end{figure}

\begin{figure}[!htpb]
	\includegraphics[width=\textwidth]{DiagramaSemanal02.pdf}
	\caption{Distribuição da carga horária semanal no 2º Ano.}
	\label{fig:DiagramaSemanal02}
\end{figure}

\begin{figure}[!htpb]
	\includegraphics[width=\textwidth]{DiagramaSemanal03.pdf}
	\caption{Distribuição da carga horária semanal no 3º Ano.}
