...
\begin{itemize}
	\item Executa, controla e monitora processos e atividades laboratoriais de biotecnologia e biociências em diversos setores indústria, meio-ambiente, agropecuária, saúde humana e animal.
	\item Controla a qualidade e a compra de matérias-primas, insumos e produtos.
	\item Prepara materiais, meios de cultura, soluções e reagentes.
	\item Prepara amostras e cultiva \textit{in vivo} e \textit{in vitro} microrganismos, células e tecidos animais e vegetais.
	\item Opera a criação e manejo de animais de experimentação.
	\item Analisa substâncias e materiais biológicos.
	\item Extrai, replica e quantifica biomoléculas.
	\item Realiza a produção de imunobiológicos, vacinas, diluentes, kits de diagnóstico e bioprocessos industriais.
	\item Colabora nas atividades de perícia criminal e investigação genética. 
	\item Desenvolve pesquisa em biotecnologia.
	\item Compreende e domina os fundamentos científico-tecnológicos do seu trabalho.
	\item Respeita as diversidades e os direitos humanos e tem atitude ética no trabalho e fora dele.
	\item Compreende e tem senso críticos frente aos projetos políticos de desenvolvimento nacional.
	\item Tem compromisso com a democracia e a responsabilidade social e ambiental.
	\item Cumpre da legislação ambiental.
	\item Avalia tendências no desenvolvimento da ciência e da tecnologia.
...
A distribuição das disciplinas com Ensino, Pesquisa e Extensão de forma indissociável ao longo dos anos é apresentado no diagrama da Figura~\ref{fig:intinerario}.
...
\begin{table}[H]
	...
	\resizebox{\textwidth}{!}{%
		\begin{tabular}{|l|l|l|l|l|l|}
			...
			& \nameref{disc:estudo}                                                        & 4          & 4         & 0         & 216       \\ \hline	
			...
			\multicolumn{2}{|l|}{Número de disciplinas por ano}                            & 16         & 16        & 13        & 45        \\ \hline
		\end{tabular}%
	}
\end{table}
...
\begin{figure}[!htp]
	\centering
	\includegraphics[width=.9\textwidth]{DiagramaSemanal01.jpg}
...
\begin{figure}[!htp]
	\centering	
	\includegraphics[width=.9\textwidth]{DiagramaSemanal02.jpg}
...
\begin{figure}[!htp]
	\centering	
	\includegraphics[width=.9\textwidth]{DiagramaSemanal03.jpg}
...
\newpage
\section{Estudo orientado e prática profissional}\label{ementasEstudo}
\indent
...
Alicerçados no conhecimento e na inovação, e promovendo a aprendizagem colaborativa, a disciplina de estudos orientados e prática profissional desenvolve nos estudantes a capacidade de trabalharem em equipe e aprenderemcom seus pares, além de estimular atitudes cooperativas e propositivas preparando-os para os desafios da comunidade, do mundo do trabalho e da sociedade em geral.
...
\subsection{Estudo orientado e prática profissional}\label{disc:estudo}
\begin{itemize}
	\item \textbf{Carga horária (hora/aula):} 216
	\item \textbf{Docente Responsável:}
	\item \textbf{Conceitos-Chave:}
	\begin{itemize}
		...
		\item NNNNN
	\end{itemize}
	\item \textbf{Ementa:} Momento presencial com carga horária de 4 horas por semana para estudos dirigidos interdisciplinares; Debates de temas com dois grupos: um pró e um contra;
	\item \textbf{Bibliografia básica}
	\begin{enumerate}
		\item NNNNN
	\end{enumerate}
