...
As Diretrizes Curriculares Nacionais para o Ensino Médio (BRASIL, 2018), recentemente atualizadas, em consonância com a Lei de Diretrizes e Bases da Educação (BRASIL, 1996), trazem
em seu Capítulo II as formas de Oferta e Organização Curricular. De acordo com as Diretrizes Curriculares Nacionais para o Ensino Médio, entre outros:
...
deste aforma, o Curso Técnico Integrado ao Ensino Médio em Biotecnologia, emconsonância com as mais recentes reestruturações do ensino, funcionará em período matutino e vespertino.
...
\begin{table}[H]
	...
	\resizebox{\textwidth}{!}{%
		\begin{tabular}{|l|l|l|l|l|l|}
			...
			& \nameref{disc:bioquimica}                                       & 0          & 3         & 0         & 81       \\ \cline{2-6} 
			...
			& \nameref{disc:analitica}                          & 0          & 3         & 0         & 81       \\ \hline
			\multicolumn{2}{|l|}{Carga horária semanal Núcleos Básico, Politécnico e Profissional} & 38         & 38        & 38        & 3078      \\ \hline
